module github.com/boostchicken/cmd/lol // import "github.com/boostchicken/cmd/lol"
...
require (
	...
	github.com/boostchicken/lol/clients/secrets v0.0.0-20211013185905-8b9b8b8b8b8b // indirect
