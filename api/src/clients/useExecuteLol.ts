...
export function executeLolQueryOptions <
  TData = ExecuteLolQueryResponse, TError = ExecuteLol302 | ExecuteLol404
>(
  params?: ExecuteLolQueryParams, options: Partial<Parameters<typeof client>[0]> = {}
...
export function useExecuteLol <TData = ExecuteLolQueryResponse, TError = ExecuteLol302 | ExecuteLol404>(params?: ExecuteLolQueryParams, options?: { 
